...
export const metadata: Metadata = { title: 'Care Guide | GS Chairs', description: 'How to care for your solid-wood GS Chairs table or chair so it lasts for generations.' };

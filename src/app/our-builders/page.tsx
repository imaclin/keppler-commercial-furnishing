    ...
    <>
      ...
      <main>
        <RichHero
          ...
          subtitle="Every HW piece is built by a real person in a small American workshop — not stamped out on a line."
        />
        ...
        <Quote text="They build small on purpose, so every piece gets the attention it deserves." attribution="On the HW Workshops" />

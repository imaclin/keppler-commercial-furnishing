...
export const metadata: Metadata = { title: 'Order Status | HW', description: 'Check the status of your HW order and track your handcrafted piece from the workshop to your door.' };
...
export default function OrderStatusPage() {
  return (
    <ContentPage
      ...
      title="Order Status"
      intro="Every HW piece is built to order, so your order moves through a few clear stages. You can follow it from your account at any time."
      sections={[

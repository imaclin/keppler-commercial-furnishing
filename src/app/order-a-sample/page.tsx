...
export const metadata: Metadata = { title: 'Order a Sample | Keppler Commercial Furnishing', description: 'Order wood and finish samples to see and feel your Keppler piece before you commit.' };

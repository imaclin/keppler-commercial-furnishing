...
export const alt = 'Keppler Commercial Furnishing: handcrafted American solid-wood furniture';

// Default social share card: Keppler Commercial Furnishing wordmark on a warm bone background. The

...
export const metadata: Metadata = { title: 'FAQ | HW', description: 'Answers to common questions about HW furniture, ordering, wood, delivery, and care.' };
...
export default function FaqPage() {
  return (
    <ContentPage
      ...
      sections={[
        { heading: 'Is everything really solid wood?', body: 'Yes. Our tables and chairs are built from solid American hardwood throughout — no particle board, MDF, or veneer over filler.' },

...
export function InviteAcceptForm({ token, presetEmail, role }: { token: string; presetEmail: string | null; role: string }) {
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-[var(--stone)]">You&rsquo;ve been invited to join the HW team as <span className="font-medium capitalize text-[var(--ink)]">{role}</span>. Set up your account to continue.</p>
